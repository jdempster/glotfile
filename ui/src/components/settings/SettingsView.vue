          ...
          <div v-else-if="activeSection === 'guidance'" class="flex flex-col gap-7">
            <div class="grid gap-1.5">
              ...
              <Textarea
                ...
                placeholder="What the product is, who uses it, and how key terms should be read. e.g. “Acme is a workplace visitor-management system; treat ‘sign in’ as physically checking in at a building, never as logging into an account.”"
              />
