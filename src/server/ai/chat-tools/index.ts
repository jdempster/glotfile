...
// codebase, and make FOCUSED, single-item changes — project/locale guidance,
// glossary terms, per-key context/notes, and individual translation fixes.
// Deliberately NO bulk action (mass translate/review): Lingo suggests those and
// the user runs them from the app's own controls.
export function buildToolRegistry(): ChatTool[] {
  return [...stateReadTools, ...codebaseTools, ...guidanceWriteTools, ...glossaryWriteTools, ...keyWriteTools];
}
