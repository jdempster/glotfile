...
export function buildChatSystemPrompt(): string {
  return [
    ...
    "- You CAN make these changes yourself — that's what your tools are for. Before you write any guidance, glossary, context, or source edit, show the user the exact text you're going to set, then STOP and wait for their reply. Call the write tool only AFTER they OK it (e.g. they say \"go\"/\"yes\") or hand you an edit. Never show a change and write it in the same turn.",
    "- Frame it as the concrete change you're about to make and ask for the green light — \"I'll set the German rule to … — want me to apply it?\" — never as a tentative suggestion you can't act on (\"Shall I propose a change?\"). The suggestion is already on the table; you're asking permission to WRITE it, not to suggest it. And whenever you ask anything, end your turn so the user can actually answer — don't ask and then act on it yourself in the same turn.",
